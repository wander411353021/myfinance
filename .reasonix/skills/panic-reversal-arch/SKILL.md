...
- **条件**:黄金坑 + 快启动(≤5天) + 坑长≥8天 + 出坑前后7天内放量堆峰值量比≥5
- **全市场5534只验证**:n=671, r60胜率 93.3%,均值+33.2%,中位+27.3%,p10=+4.8%(最差10%也小赚),
  盈亏比4.6(盈利+36.1%/亏损-7.9%);1000只复验 92.0%——非过拟合
- **面板标记**:GOLD PIT 金色★(最醒目),原坑标记(红柱快启动/橙蓝灰质量/斜纹高位)全部保留——有分辨率
- 函数:mark_super_pits(pits, closes, volumes, min_len=8, peak_ratio=5.0, fast_days=5, window_days=7)
- 收益分布:60%+ 交易赚20%+,27.4% 赚50%+(厚尾主升);亏损仅8%且平均-10%
